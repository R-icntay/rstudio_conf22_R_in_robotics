...
Awesome!
That's how R played a role at each step of our project.
You can find how we combined the code chunks from these four chapters and the user defined functions we created along the way to make our manipulator move: [R](https://github.com/R-icntay/rstudio_conf22_R_in_robotics/tree/main/R)
...
And that's it!
There goes a touch of R in robotics.
